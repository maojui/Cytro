...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_60 = Integer(60); _sage_const_4 = Integer(4); _sage_const_p26 = RealNumber('.26'); _sage_const_0p292 = RealNumber('0.292')#!/usr/bin/env sage
...
def main(N,e):
    ...
    delta = _sage_const_p26  # d < N^delta
